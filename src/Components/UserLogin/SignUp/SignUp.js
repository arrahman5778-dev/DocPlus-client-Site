      ...
      <div className="w-full lg:w-1/3 md:w-2/3 mx-auto p-5 mt-[8rem] rounded-lg bg-green-200 ">
        ...
        {emailError ? (
          <p className="text-left mb-7 text-red-600 flex">
            <XIcon className="w-5 mr-2"></XIcon> {emailError}
          </p>
        ) : (
          ""
        )}
        ...
        <div className="flex flex-col text-left mb-8">
          <label className=" text-xl  ml-2 mb-2" htmlFor="password">
            Password
          </label>
          <input
        ...
        {passError ? (
          <p className="text-left mb-7 text-red-600 flex">
            <XIcon className="w-5 mr-2"></XIcon> {passError}
          </p>
        ) : (
          ""
        )}
        <div className="flex flex-col text-left mb-8">
          <label className=" text-xl  ml-2 mb-2" htmlFor="ComfirmPassword">
            Comfirm Password
          </label>
          <input
            onChange={comfirmPassClick}
            className="py-2 rounded-lg shadow-md border-0 outline-0 px-4 text-xl"
            type="password"
        ...
        {comfirmPassError ? (
          <p className="text-left mb-7 text-red-600 flex">
            <XIcon className="w-5 mr-2"></XIcon> {comfirmPassError}
          </p>
        ) : (
          ""
        )}
