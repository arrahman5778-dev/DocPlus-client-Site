        ...
        <div className="hero max-w-7xl mx-auto">
            <div className='py-28 px-5 block lg:flex items-center justify-between'>
                <div className="hero-text w-full lg:w-6/12 text-left">
                    <h1 className='lg:text-8xl md:text-7xl text-5xl font-mono font-bold mb-8'>HealthCare <br /><span className=' text-green-900 lg:text-7xl md:text-6xl text-4xl font-sans'> For All</span></h1>
